...
export function collectCommandOptions(
  ...
  routerOptions?: Record<string, import('../components/Command').CommandOption>
): Record<string, import('../components/Command').CommandOption> {
  const allOptions: Record<string, import('../components/Command').CommandOption> = {};
