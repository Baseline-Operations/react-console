 ...
 * ```
 */
export function resolveSize(size: ResponsiveSize | undefined, dimension: 'width' | 'height', maxSize?: number): number | undefined {
 ...
 * ```
 */
export function resolveWidth(width: ResponsiveSize | undefined, maxWidth?: number): number | undefined {
 ...
 * ```
 */
export function resolveHeight(height: ResponsiveSize | undefined, maxHeight?: number): number | undefined {
