...
import { Stylable, Renderable, type OutputBuffer, type RenderContext, type RenderResult } from '../base/mixins';
 ...
 * Fragment node - groups children without creating a container
 */
export class FragmentNode extends Stylable(Renderable(Node as any)) {
