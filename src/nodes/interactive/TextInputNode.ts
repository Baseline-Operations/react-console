/**
 * TextInput node - text input field
...
const TextInputNodeBase = Stylable(
 ...
 * TextInput node - text input field
 */
export class TextInputNode extends TextInputNodeBase implements TextInputNodeMixins {
  ...
  declare onChangeText?: (text: string) => void;
  ...
  renderToCellBuffer(context: {
    ...
    debug('[TextInputNode] renderToCellBuffer', { x, y, isFocused, isMultiline, maxHeight });
  ...
  private renderInputText(
    ...
    debug('[TextInputNode] renderInputText (legacy)', {
      x,
      y,
      isFocused,
      prefix: isFocused ? '[ ' : '  ',
  ...
  private emitChange(): void {
    // Call React Native style onChangeText
    this.onChangeText?.(this.value);
    // Call legacy onChange
...
/** @deprecated Use TextInputNode instead */
export const InputNode = TextInputNode;
