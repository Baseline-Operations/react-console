...
describe('Mixins', () => {
  it('should compose Stylable mixin', () => {
    const StylableNode = Stylable(TestNode as Constructor<TestNode>);
  ...
  it('should compose Renderable mixin', () => {
    const RenderableNode = Renderable(TestNode as Constructor<TestNode>);
  ...
  it('should compose Layoutable mixin', () => {
    const LayoutableNode = Layoutable(TestNode as Constructor<TestNode>);
  ...
  it('should compose Interactive mixin', () => {
    const InteractiveNode = Interactive(TestNode as Constructor<TestNode>);
  ...
  it('should compose multiple mixins', () => {
    const ComposedNode = Stylable(Renderable(Layoutable(TestNode as Constructor<TestNode>)));
