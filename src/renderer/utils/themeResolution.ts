...
export function applyThemeToStyle(
  ...
  const merged = mergeComponentTheme(componentType, style as any, theme);
  ...
  if (resolved.backgroundColor && typeof resolved.backgroundColor === 'string' && resolved.backgroundColor in theme.colors) {
    resolved.backgroundColor = resolveColor(resolved.backgroundColor);
  }
  
  if (resolved.borderColor && typeof resolved.borderColor === 'string' && resolved.borderColor in theme.colors) {
